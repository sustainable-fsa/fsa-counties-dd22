...
-   [`FSA_Counties_dd22_NonGeneralized.gdb.zip`](https://sustainable-fsa.com/fsa-counties-dd22/FSA_Counties_dd22_NonGeneralized.gdb.zip) – Original USDA File Geodatabase
-   [`fsa-counties-dd22.topojson`](https://sustainable-fsa.com/fsa-counties-dd22/fsa-counties-dd22.topojson) – Simplified TopoJSON version with pre-inset Alaska/Hawaii/Puerto Rico (see below)
